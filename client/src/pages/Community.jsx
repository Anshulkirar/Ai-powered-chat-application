...
const Community = () => {
  ...
  return (
    <div className='p-6 pt-12 xl:px-12 2xl:px-20 w-full max-auto h-full
    overflow-y-scroll'>
      ...
      {images.length > 0 ? (
        <div className='flex flex-wrap max-sm:justify-center gap-5'>
          {/* Render images or other content here */}
          {images.map((item, index)=>(
            ...
            transition-shadow duration-300'>
              ...
              2xl:h-62 object-cover group-hover:scale-105 transition-transform duration-300 ease-in-out'/>
